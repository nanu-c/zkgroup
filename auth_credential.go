...
/*
#cgo linux,arm64 LDFLAGS:  -Wl,-rpath=$ORIGIN/lib/libzkgroup_linux_arm64.so
#cgo linux,arm LDFLAGS:   -Wl,-rpath=$ORIGIN/lib/libzkgroup_linux_armhf.so
#cgo linux,amd64 LDFLAGS:  -Wl,-rpath=$ORIGIN/lib/libzkgroup_linux_amd64.so
